...
class AIWebsiteTester:
    ...
    def __init__(self, model_name="gpt-3.5-turbo"):
        ...
        if not LANGCHAIN_OPENAI_AVAILABLE or not LANGGRAPH_AVAILABLE:
            raise ImportError("LangChain OpenAI and LangGraph are required. Please install: pip install langchain-openai langgraph")
